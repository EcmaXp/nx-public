  ...
  options.nx = {
    ...
    home = {
      ...
      programs = {
        ...
        gomi.enable = enable "gomi trash configuration";
        herdr.enable = enable "herdr configuration";
        locale.enable = enable "locale and CJK width configuration";
        man.enable = enable "manual page configuration";
        micro.enable = enable "micro editor configuration";
        ...
        python.enable = enable "Python environment configuration";
      ...
      shells = {
        ...
        path.enable = enable "shell PATH deduplication";
        plugins = {
